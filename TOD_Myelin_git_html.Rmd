...
##T1/T2 ratio by CT, Dx, and CT by Dx interactions controlling for age, sex, and CNR 
...
T1T2ratio_CT <- lapply(1:n, function(x) lm(T1T2ratio_aparc[,x] ~ CT_aparc[,x] + Age + Group + Sex + gray_white_cnr + CT_aparc[,x]*Group, data=TOD_Myelin_aparc))
...
##T1/T2 ratio by volume, Dx, and volume by Dx interactions controlling for age, sex, and CNR 
...
T1T2ratio_volume <- lapply(1:n, function(x) lm(T1T2ratio_aparc[,x] ~ Volume_aparc[,x] + Age + Group + Sex + gray_white_cnr + Volume_aparc[,x]*Group, data=TOD_Myelin_aparc))
